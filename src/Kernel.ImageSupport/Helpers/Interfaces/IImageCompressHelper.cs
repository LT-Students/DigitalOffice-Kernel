...
public interface IImageCompressHelper
{
  ...
  /// </summary>
  /// <remarks>
  /// Allows to compress images of following formats: ".jpg", ".jpeg", ".png", ".bmp", ".gif", ".tga", ".svg", ".webp", ".tiff", ".pbm", ".svg".
  ...
  /// minimal quality value is 10% - compessing stops even if current weight is heigher then required.
  /// If compressing is successfull, returns boolean "true", compressed image content and final extension.
  ...
  /// If rcompressing is not successfull, returns boolean "false", null image content and original image extension.
  /// </remarks>
